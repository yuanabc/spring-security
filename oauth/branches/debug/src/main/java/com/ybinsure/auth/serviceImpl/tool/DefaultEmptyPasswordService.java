...
public class DefaultEmptyPasswordService implements EmptyPasswordService {
    ...
    private final static String PREFIX = "oauthDefaultEmptyPassword";
    ...
    public void storeCryptDefaultPassword(String userId) {
        stringRedisTemplate.opsForValue().set(PREFIX + userId, CRYPT_DEFAULT_PASSWORD, 60, TimeUnit.SECONDS);
    }
