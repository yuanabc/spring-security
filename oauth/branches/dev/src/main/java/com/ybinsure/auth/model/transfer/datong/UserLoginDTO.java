...
public class UserLoginDTO {
    ...
    public Optional<UserExtend> convert() {
    ...
    public UserExtend getUpdateParam(UserExtend exist) {
        UserExtend param = new UserExtend();
    ...
    public boolean isUpdated(UserExtend exist) {
    ...
    public boolean isUpdatePhone(UserExtend exist) {
        return !StringUtils.equals(getPhone(), exist.getPhone());
    }

    public boolean isUpdateCompany(UserExtend exist) {
