...
public class DefaultChannelService implements ChannelService {
    ...
    @Override
    public Optional<ChannelDO> queryChannelLinkUserAndLinkRoleById(String id) {
        if (StringUtils.isBlank(id)) {
            return Optional.empty();
        }
        return Optional.ofNullable(customChannelMapper.queryChannelLinkUserAndLinkRoleById(id, UserTypeCode.ADMIN));
    }
    ...
    public Integer maxOrderCode() {
        Integer maxOrderCode = customChannelMapper.queryMaxOrderCode();
