...
public class DefaultTokenClearService implements TokenClearService {
    ...
    public void clearByCompanyId(String companyId) {
        ...
        List<String> tokens = userLinkUserRelateCompanyService.queryLastTokenByTokenNonExpire(companyId).orElseGet(ArrayList::new);
        clearToken(tokens);
    }
    ...
    private void clearToken(List<String> tokens) {
