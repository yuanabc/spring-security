...
public class VerificationCodeEndpoint {
    ...
    @ApiOperation(value = "后台账号发送验证码")
    public Result<Void> verificationCodeSendWithUserName(
    ...
    @ApiOperation(value = "前端账号发送验证码")
    public Result<Void> verificationCodeSendWithPhone(
    ...
    @ApiOperation(value = "前端账号发送注册验证码")
    public Result<Void> verificationCodeSendWithPhone(
            @ApiParam(value = "手机号码", required = true)
    ...
    public Result<Void> verify(
            @ApiParam(value = "请求数据, 必要字段：phone, channelCode, captcha")
            @Validated(UserDO.Verify.class)
    ...
    @ApiOperation(value = "根据用户名更新密码")
    public Result<Boolean> changePasswordWithUserName(
            @ApiParam(value = "请求数据，必要字段：userName，password，captcha")
            @Validated(UserDO.VerifyCaptchaWithUserName.class)
            @RequestBody()UserDO param, BindingResult bindingResult
    ) {
        ValidatedResultUtil.checkFieldThrow(bindingResult);
    ...
    @ApiParam(value = "根据手机号码更新密码")
    public Result<Boolean> changePasswordWithPhone(
        @ApiParam(value = "请求数据，必要字段：phone，password，captcha")
        @Validated(UserDO.VerifyCaptchaWithPhone.class)
        @RequestBody() UserDO param, BindingResult bindingResult
    ) {
        ValidatedResultUtil.checkFieldThrow(bindingResult);
    ...
    private Result<Boolean> changePassword(Optional<UserDO> existUser, UserDO param) {
