...
import com.ybinsure.auth.mapper.auto.UserRelateRoleDOMapper;
import com.ybinsure.auth.mapper.custom.CustomUserRelateRoleDOMapper;
...
public class DefaultUserRelateRoleService implements UserRelateRoleService {
    ...
    private final CustomUserRelateRoleDOMapper customUserRelateRoleDOMapper;
    ...
    public boolean insertList(List<UserRelateRoleDO> params) {
        ...
        return customUserRelateRoleDOMapper.insertList(params) == params.size();
    }
