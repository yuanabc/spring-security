...
public class ValidateCodeController {
	...
	public Object createCode(HttpServletRequest request, HttpServletResponse response, @PathVariable String type) throws Exception {
	...
	public Object checkCode(HttpServletRequest request, HttpServletResponse response, @PathVariable String type) {
		try {
			...
			WrapMapper.wrap(ErrorCodeEnum.BA100400, e);
		} catch (Exception e) {
